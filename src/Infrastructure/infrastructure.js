            ...
            <div className="Infrastructure-content">
                <div className="Card">
                    <div className="Card-content">
                        <div className="Card-imageContainer"><img src="/icons/plug.png" alt="Электричество" className='Card-image'/></div>
                ...
                <div className="Card">
                    <div className="Card-content">
                        <div className="Card-imageContainer"><img src="/icons/drop.png" alt="Вода" className='Card-image'/></div>
                ...
                <div className="Card">
                    <div className="Card-content">
                        <div className="Card-imageContainer"><img src="/icons/road.png" alt="Дорога" className='Card-image'/></div>
                ...
                <div className="Card">
                    <div className="Card-content">
                        <div className="Card-imageContainer"><img src="/icons/bus.png" alt="Вода" className='Card-image'/></div>
