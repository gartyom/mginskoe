  ...
  function renderPlaces() {
    const p = [
      ...
      },
      {
        ...
        icon: "/icons/walk.png",
        description:
          "Несмотря на близость к Петербургу, рядом с деревней раскинулись тысячи гектар лесных массивов. В этих девственных лесах даже сейчас легко встретить любое дикое животное, характерное для Ленинградской области. Чаще всего встречаются кабан, лось, заяц, лисица.",
      },
      {
        name: "город Кировск",
      ...
      },
      {
        ...
        distance: "~ 14 км",
        description:
          "Катание на лодках и катерах, рыбалка. Главная рыба, которую здесь можно поймать – корюшка. Так же попадаются окунь, лещ, угорь, минога, судак и другие.",
      },
      {
        name: "Река Мга",
        ...
        distance: "~ 400 м",
        description:
          "Воды Мги имеют темно-коричневую окраску, что связано с исходом из торфяной местности. Река Мга очень красивая и интересна для рыбалки. Виды рыбы очень разнообразны и представлены лещом, щукой, судаком, плотвой, окунем, сомом, густерой, ельцом.",
      },
      {
        ...
        distance: "~ 33 км",
        description:
          "Один из наиболее интересных в геологическом отношении памятников природы Ленинградской области. Река имеет цвет зелёного чая из-за торфяных веществ. Каньон тянется на 7 километров, а берега реки достигают в высоту 25 метров.",
      },
      {
          ...
          <div className="Place-content">
            <div className="Place-imageContainer">
              <img
                ...
                src={process.env.PUBLIC_URL + place.img}
                alt=""
                loading="lazy"
              ></img>
            </div>
            <div className="Place-description" onClick={handleCardClick}>
              ...
              <div className="Place-text">
                ...
                <div className="Place-mainText">{place.description}</div>
  ...
  return (
    <div className="Places" id="Places">
      ...
      <div className="Places-content">
        <div className="Places-container">{renderPlaces()}</div>
        <div className="Places-history">
          ...
          <ul className="Places-historyList">
            <li className="Places-historyListItem">
              На карте Ингерманландии,  составленной по шведским материалам 1676
              года, упоминается деревня Pucschowick.
            </li>
            <li className="Places-historyListItem">
              На шведской «Генеральной карте провинции Ингерманландии» 1704
              года, составленной по материалам 1678 года она упомянута,
              как Puchala.
            </li>
            <li className="Places-historyListItem">
              На карте Санкт-Петербургской губернии Я. Ф. Шмита 1770 года она
              обозначена, как деревня Пухолова.
            </li>
            <li className="Places-historyListItem">
              На карте Санкт-Петербургской губернии Ф. Ф. Шуберта 1834 года
              обозначена деревня Пухолово, состоящая из 31 крестьянского двора.
              В деревне находилась водяная мельница.
            </li>
            <li className="Places-historyListItem">
              В 1837 году Княгиня Т. В. Юсупова стала полноправной хозяйкой
              деревень Пухолово и Сологубовка. Юсуповы – одна из самых видных по
              происхождению и богатству русских дворянских фамилий. Им
              принадлежали все земли в этой округе.
            </li>
          </ul>
        </div>
      </div>
